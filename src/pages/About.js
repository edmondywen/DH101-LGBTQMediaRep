        ...
        <Template>
            <div id="aboutpage">
                ...
                <div id="about-auth">
                    ...
                    <div id="biographies">
                        <Bio image={ariana} name="Ariana Castro" role="Web Designer" about="Ariana is a second-year English major and Digitial Humanities minor. As web designer, she established guidelines for the project's fonts and color palette, handpicked images for each page, and illustrated graphics to enhance the site's overall aesthetic. She designed wireframes to organize all these components. Moreover, she assisted in the creation of data visualizations as well as written content." char={<span>Her queer icon from the dataset is <b>Alucard</b> from <b>Castlevania</b>!</span>}/>
                        <Bio image={sara} name="Sara Hisamune" role="Editor & Data Specialist" about="Sara is a fourth-year Economics major. As one of the project’s editors, she assisted in writing the project’s narrative and introductory paragraphs ー as well as editing these sections for grammatical and contextual flow. As one of the project’s data visualization specialists, she also contributed two of her data visualizations to the project and helped embed other members’ visualizations within the wider narrative." char={<span>Her queer icon from the dataset is <b>Caitlyn</b> from <b>Arcane</b>!</span>}/> 
                        <div class="flexbreak-2"/>
                        <Bio image={satsuki} name="Satsuki Liu" role="Developer" about="Satsuki is a fourth-year Computer Science major. As one of two developers, she was responsible for helping build the website using React and CSS. They designed the about and sources pages, as well as providing general styling and auxiliary work on the landing page. Additionally, she was responsible for creating the layout of some of the final website's subpages, as well as designing one of the graphs used in the gender component of the narrative." char={<span>Their queer icon from the dataset is <b>Stat</b> from <b>Q-Force</b>!</span>}/>
                        <div class="flexbreak-3"/>
                        <Bio image={an} name="An Nguyen" role="Editor" about="An is a fourth-year Biochemistry major. As one of the editors, she contributed to editing the narrative to ensure the consistency of the format as well as correcting spelling and grammar errors. As one of the data visualization specialists, she oversaw the format of data visualization to make sure they were universal across the website. She also contributed one data visualization to the project." char={<span>Her queer icon from the dataset is <b>Harley Quinn</b> from <b>Harley Quinn</b>!</span>}/> 
                        <div class="flexbreak-2"/>
                        <Bio image={edmond} name="Edmond Wen" role="Developer" about="Edmond is a third year Computer Science major. As one of two developers, he created the website in React and setup the live deployment on Netlify. He setup the general website layout, designed the navbar, and was also responsible for the landing, data critique, and narrative pages. He also helped write initial drafts for the narrative, data critique, and designed some of the data visualizations." char={<span>His queer icon from the dataset is <b>Princess Bubblegum</b> from <b>Adventure Time</b>!</span>}/> 
                        <Bio image={maleeha} name="Maleeha Zaman" role="Project Manager" about="Maleeha is a second-year Cognitive Science major and Digital Humanities minor. As project manager, she oversaw the progress of the project, scheduling meetings, divided tasks, and communicated between members. She assisted in formatting the website, and created the timeline and map used in the narrative. Additionally, she assisted in editing and creating written and visual content, as well as developing a narrative across the group’s data visualizations. She also helped write the sourcing, processing, and presentation sections in the About page." char={<span>Her queer icon from the dataset is <b>Marceline</b> from <b>Adventure Time</b>!</span>}/> 
                    </div>
                </div>
