            ...
            <div className="narrative">
                ...
                <div id="intro2">
                    <div class="copy">
                        ...
                        <p>Much of this representation, however, tend to occur in the comedy genre and limits itself to primarily cisgender gay identities. Together, these observations indicate that the U.S. animation industry has taken significant steps towards increasing queer visibility ー but that this visibility falls short of representing the full spectrum of queer identities and avoiding using harmful queer stereotypes as a humor device.</p>
                        <p>The dataset we are using, entitled <em>LGBTQ representation in animated shows in the us</em>, was publicly released on Kaggle and created using an Insider database on queer cartoon characters. Containing two spreadsheets that span 19 variables and 473 data entries, the dataset includes detailed information on all queer characters that have appeared in U.S. animated shows between 1989 and 2021.</p>
                ...
                <div id="ourfindings">
                    <div class="copy">
                        ...
                        <p>In the visualization above, the x-axis displays the year while the y-axis shows the number of confirmed queer characters featured in U.S. animated shows that year.</p>

                        <p>As the line chart depicts, there have been dramatic increases in queer representation in U.S. animated shows between 1989 and 2021. Between 1991, which saw the confirmation of 2 queer characters, and 2016, which saw the confirmation of 12, we see a trend of steadily increasing queer representation. We see these numbers skyrocket in the years following 2016, taking on the values of 53, 32, and 46 characters in 2019, 2020, and 2021 respectively.</p>
                        ...
                        <p>The pie chart above shows the breakdown of queer characters featured in U.S. animated shows between 1989 and 2021 into either explicit or implicit representation. The adjacent line chart, which displays the year on the x-axis and the number of explicitly confirmed queer characters per year on the y-axis, shows how explicit queer representation has increased over the years.</p>
                        <p>As seen on the pie chart, queer representation over the past three decades has been primarily explicit, with a 74.49% majority of characters explicitly confirmed as queer. <b>Furthermore, as the line chart illustrates, such explicit representation has been appearing at faster and faster rates, particularly in the past couple of years.</b> The recent surges in queer representation, specifically explicit queer representation, signify strides in the U.S. animation industry to expand queer visibility.</p>
                        ...
                        <p>Not only do cisgender characters receive more representation in animated shows, but they also significantly outnumber non-cisgendered characters when it comes to having a defined sexual orientation in addition to their gender identity.</p>
